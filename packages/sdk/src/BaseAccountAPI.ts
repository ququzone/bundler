...
export abstract class BaseAccountAPI {
  ...
  async createUnsignedUserOp (info: TransactionDetailsForUserOp): Promise<UserOperationStruct> {
    ...
    if (this.paymasterAPI != null) {
      ...
      preVerificationGas = await this.paymasterAPI.getPreVerificationGas(partialUserOp)
      const userOpForPm = {
        ...partialUserOp,
        preVerificationGas
      }
    ...
    return {
      ...partialUserOp,
      preVerificationGas: preVerificationGas ?? this.getPreVerificationGas(partialUserOp),
      signature: ''
    }
  }
